...
public class ObjednavkyGUI extends javax.swing.JFrame {
    ...
    private DorucenieObjednavkyListener listener;
    private DorucenieObjednavkyListener listener2;
    private DorucenieObjednavkyListener listener3;
     ...
     */
    public ObjednavkyGUI(GUIManager guiManager, LoginGUI loginGUI, NahradneDielyGUI nahradneDielyGUI, ZobrazeniePoziadaviekNdGUI zobrazeniePoziadaviekNdGUI, UdrzbaNahradnyDielGUI udrzbaNahradnyDielGUI) {
        initComponents2();
        ...
        this.setDorucenieObjednavkyListener3(this.udrzbaNahradnyDielGUI);

    }

    public void setDorucenieObjednavkyListener(DorucenieObjednavkyListener listener) {
        this.listener = listener;
    }

    public void setDorucenieObjednavkyListener2(DorucenieObjednavkyListener listener) {
        this.listener2 = listener;
    }

    public void setDorucenieObjednavkyListener3(DorucenieObjednavkyListener listener) {
    ...
    private void initComponents2() {
        ...
        jButtonDorucenieObj = new javax.swing.JButton();
        ...
        jComboBoxCisloND.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBoxCisloNDActionPerformed(evt);
            }
        });
        ...
        jButtonDorucenieObj.setBackground(new java.awt.Color(255, 255, 254));
        jButtonDorucenieObj.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jButtonDorucenieObj.setText("OBJEDNÁVKA DORUČENÁ");
        jButtonDorucenieObj.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonDorucenieObjActionPerformed(evt);
            }
        });

        jLabel8.setText("názov ND*:");
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                                ...
                                                                .addGap(18, 18, 18)
                                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                                        .addComponent(jTextFieldDatumObj, javax.swing.GroupLayout.Alignment.LEADING)
                                                                        ...
                                                                        .addComponent(jButtonDorucenieObj, javax.swing.GroupLayout.Alignment.LEADING)))
        ...
        jPanel1Layout.setVerticalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel8)
                                        .addComponent(jTextFieldNazovND, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(30, 30, 30)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel3)
                                        .addComponent(jComboBoxCisloObj, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(jButtonDorucenieObj, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String [] {
                        "číslo náhradného dielu", "číslo objednávky", "množstvo", "cena", "dátum objednávky", "dátum doručenia", "názov ND"
                }
        ) {
    ...
    private void jComboBoxCisloNDActionPerformed(java.awt.event.ActionEvent evt) {
        TypedQuery<Object[]> query;
        List<Object[]> result;
        String id;
        id = (String) jComboBoxCisloND.getSelectedItem();

        if (id.equals(" ")){
            jTextFieldNazovND.setText("");
            return;
        }
        BigInteger idBigInteger = new BigInteger(id);
        try {
            transaction.begin();
            query = entityManager.createQuery("SELECT DISTINCT nd.nazovND FROM BNahradnyDiel nd " +
                    "WHERE nd.cisloNd = :id ", Object[].class);
            query.setParameter("id", idBigInteger);
            result = query.getResultList();

            jTextFieldNazovND.setText(result.toString());
            // Commit
            transaction.commit();
        } catch (Exception e) {
            e.getCause();
        ...
        try {
            ...
            TypedQuery<Object[]> query = entityManager.createQuery(
                    "SELECT p.cisloObjednavky, p.cisloNd, p.mnozstvo, p.cena, o.datumObjednavky, o.datumDorucenia, nd.nazovND " +
                            ...
                            "JOIN BNahradnyDiel nd ON nd.cisloNd = p.cisloNd ", Object[].class);
    ...
    private void jTableMouseClick_ActionPerformed(MouseEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String nazovND = (String) jTable1.getValueAt(rowNumber,6);
    ...
    private void jButtonDorucenieObjActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            transaction.begin();
            // najdenie Objednavky
            BigInteger cisloObj = (BigInteger) jTable1.getValueAt(actualRowNumber, 1);
            ...
            // nastavenie GUI
            bObjednavka.setDatumDorucenia(dateF);

            // ziskanie vsetky ND z danej objednavky
            // ziskanie dat - JPQL
            TypedQuery<Object[]> query = entityManager.createQuery(
                    "SELECT p.cisloNd, p.mnozstvo " +
                            "FROM BPolozkaObjednavky p " +
                            "JOIN BObjednavka o ON p.cisloObjednavky = o.cisloObjednavky " +
                            "WHERE o.cisloObjednavky = :cisloObj ", Object[].class);
            query.setParameter("cisloObj", cisloObj);
            //list nahradnych dielov
            List<Object[]> results = query.getResultList();
            BigInteger mnozstvo = BigInteger.valueOf(0);
            for (Object[] result : results) {
                BNahradnyDiel bNahradnyDiel = entityManager.find(BNahradnyDiel.class, result[0]);
                mnozstvo = bNahradnyDiel.getDostupneMnozstvo();
                mnozstvo = mnozstvo.add((BigInteger) result[1]);
                bNahradnyDiel.setDostupneMnozstvo(mnozstvo);
            }
            entityManager.persist(bObjednavka);
            transaction.commit();
            // Notify listeners about the success
            if (listener != null && listener2 != null && listener3 != null) {
                listener.onDorucenieSuccess();
                listener2.onDorucenieSuccess();
                listener3.onDorucenieSuccess();
            }
    ...
    private javax.swing.JButton jButtonDorucenieObj;
